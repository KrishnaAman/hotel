...
const AddRoom = () => {
  ...
  const { getToken, setIsOwner, isOwner } = useAppContext()
  ...
  useEffect(() => {
    const checkOwner = async () => {
      try {
        ...
        if (data.success && data.hotel) setIsOwner(true)
  ...
  if (!isOwner) {
    return (
      <p className="text-center mt-10">You need to register your hotel first to access the dashboard.</p>
    )
  }
