...
const ListRoom = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Room Listings' subTitle='View, edit, or manage all listed rooms. Keep the information
          ...
          <table className='w-full'>
             <thead className='bg-gray-50'>
                    <tr>
                        ...
                        <th className='py-3 mac-sm:hidden px-4 text-gray-800 font-medium'>
                            Facility
                        </th>
